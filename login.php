...
<html lang="es">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg ">
                                    ...
                                    <div class="card-body">
                                        <form  class="row" role="form" autocomplete="off" id="formIniciar">

                                        <div class="input-group  campo" >
											<span class="input-group-text"><i class="fa fa-user"></i></span>
											<div class="form-floating form-floating-group flex-grow-1">
                                            <input class="form-control" id="inputEmail" type="email" placeholder="Usuario"  name="correo"  />
                                        ...
                                        <div class="input-group  campo" >
											...
											<div class="text-danger" id="mensajesession"></div>
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="btn btn-danger" onclick="iniciar()">Ingresar</a>
                                            </div>
                                        </form>
                                    </div>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            ...
                            <div>
								 <a href="https://wa.me/595976496814">Soporte</a>
                            </div>
                        </div>
                    </div>
                </footer>
	...
	function iniciar(){
		formRegistro('formIniciar', 'formIniciar', validarLogin(), logininiciar, 'Usuario')
	}
	...
	function logininiciar(resultado) {
	  if(resultado.error){
		...
		console.log('Nivel de acceso desde servidor:', resultado.nivel_acceso);

		// Esperar 1 segundo para que la sesión se establezca en el servidor
		setTimeout(function(){
			// Redirigir a verificar.php que hará el redireccionamiento correcto
			irUrl('verificar.php');
		}, 1000);
	  }
	}
