...
<div class="card mb-4">
	<div class="card-body">
		...
		<?php if(isset($_SESSION['usuario'])){  ?>
			...
			<div class="input-group col-sm-3" id="divbarrios" >
				<span class="input-group-text"><i class="fa fa-map-marker-alt"></i></span>
				<div class="form-floating form-floating-group flex-grow-1">
		 ...
		 <?php } ?>	
			...
			<button type="button" class="btn btn-warning col-sm-1  col-sx-4 " style="display:none" id="btndescargar" onclick="descargar('descargarPersonas')""><i class="fa fa-file-excel"></i> EXCEL </button>
		</form>
	</div>
</div>
														...
														<div class="row">
															   ...
															   <div class="input-group campo" >
																  ...
																  <div class="input-group campo " >
																	<span class="input-group-text"><i class="fa fa-circle-phone-flip"></i></span>
																	<div class="form-floating form-floating-group flex-grow-1">
																		<input type="number" class="form-control" style="height: 60px;" name="telefono2" id="telefono2" placeholder="Teléfono 2">
...
<script>
	...
	function editarRegistro(resultado){
		$("#formRegisto")[0].reset()
		  ...
		  $("#formRegisto #telefono2").val(resultado.telefono2);
